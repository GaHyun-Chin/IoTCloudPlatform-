...
#include "DHT.h"
#define DHTPIN 2     // DHT 센서에 연결된 디지털 핀
...
void getDeviceStatus(char* payload) {
  ...
  // 디바이스 업데이트 주제($aws/things/MyMKRWiFi1010/shadow/update)에 대한 페이로드 생성
  sprintf(payload,"{\"state\":{\"reported\":{\"temperature\":\"%0.2f\",\"humidity\":\"%0.2f\",\"soil_moisture\":\"%d\",\"light\":\"%d\"}}}",t,f,moi,CDS);
...
void onMessageReceived(int messageSize) {
  ...
  // 디바이스가 구독한 토픽이 $aws/things/MyMKRWiFi1010/shadow/update/delta
  // JSon 문자열 형식은 다음과 같다.
  // {
  //    "version":391,
